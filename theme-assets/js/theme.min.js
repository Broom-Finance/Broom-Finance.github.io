...
$(window).on("load", function() {
    ...
    function(n, a, e) {
        ...
        e(s).scrollspy({
            target: "#navigation"
        }), navbarSlideLine(), e(n).on("activate.bs.scrollspy", function(n) {
            navbarSlideLine()
        }), e(n).scroll(function() {
            ...
            if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                var a = e(this.hash);
                (a = a.length ? a : e("[name=" + this.hash.slice(1) + "]")).length && (n.preventDefault(), e("html, body").animate({
            ...
            callbacks: {
                stop: function() {
                    e(".message").html("The clock has stopped!")
                }
            }
        })).setTime(81e5), o.setCountdown(!0), o.start(), e(".video-btn").click(function() {
            i = e(this).data("src")
        }), e("#ico-modal").on("shown.bs.modal", function(n) {
            e("#video").attr("src", i + "?rel=0&amp;showinfo=0&amp;modestbranding=1&amp;autoplay=1")
        ...
        e(n).width() < 992 && t.slideTo(0, 1e3, !1), e(n).resize(function() {
            e(n).width() < 992 && t.slideTo(0, 1e3, !1)
        })
